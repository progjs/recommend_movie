...
icon = Image.open("C:/mypython/ecommend_movie/cloud2.png")
mask = Image.new("RGB", icon.size, (255, 255, 255))
mask.paste(icon, icon)
mask = np.array(mask)
font_path = "C:/mypython/recommend_movie/BMJUA_ttf.ttf"

exclude_set = {'영화', '평점' '많은', '많이', '너무', '정말', '진짜', '그리고', '가장', '제일', '이런', '하는', '엄청', '조금', '완전', '계속', '할때', '있어', '있는', '있었던', '어떤', '이런', '않고', '보다', '그래도', '봤는데', '보는', '어느', '하고', '하지만', '이렇게', '있다', '있어서', '이렇게', '봤습니다', '봤음', '이게', '아니라', \
               '대한', '한다', '하지', '동안', '것이', '보고', '있고', '얼마나', '봐도', '이거', '그냥', '것을', '특히', '이거','재밌', '좋은', '내가', '보면', '나를', '좋고', '아니', '지금', '무서', '봐야', '봤다', '봤으니', '봤다는데','합니다', '않은', '했던', '봤어요', '별점', '아주'}
# print(exclude_set)
...
for idx, texts in enumerate(comments_list):
    ...
    plt.axis("off")
    # plt.show()
    wordcloud.to_file("C:/mypython/recommend_movie/django_movie/movieapp/static/movieapp/img/wordcloud/{}.png".format(
        movie_id_list[idx]))
